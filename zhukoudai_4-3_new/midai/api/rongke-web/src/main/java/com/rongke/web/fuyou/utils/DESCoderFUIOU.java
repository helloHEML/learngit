...
/*	private static String removeBR(String str) {
    ...
    public static String getKey(String name) {
        ...
        buffer.append(DigestUtils.md5Hex(DigestUtils.md5Hex(name + "fuiou"))).append(DigestUtils.md5Hex(name + "20160112")).append(DigestUtils.md5Hex(name + "mpay")).append(DigestUtils.md5Hex(DigestUtils.md5Hex(name)));
